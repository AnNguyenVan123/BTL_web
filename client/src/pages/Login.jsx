...
export default function LoginPage() {
  ...
  const { user, setUser, loginWithEmail, loginWithGoogle, signOut } = useAuth();
  ...
  // Chuyển qua trang tạo tài khoản
    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 flex items-center justify-center p-6">
      ...
      >
        ...
        <div className="flex items-center gap-4 mt-4">
          <div className="w-12 h-12 rounded-full from-indigo-500 to-pink-500 flex items-center justify-center text-white font-bold">
            A
          </div>
          <div>
